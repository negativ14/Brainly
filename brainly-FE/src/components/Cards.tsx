        ...
        <div className="bg-white rounded-md shadow-md border-slate-900 h-fit w-fit max-w-80 p-4">
            <div className="flex justify-between">
                ...
                <div className="flex gap-x-2 items-center flex-shrink-0">
                    <div className="hover:cursor-pointer" onClick={shareCardHandler}><ShareIcon colour='gray' /></div>
                    <div className="hover:cursor-pointer" onClick={deleteHandler}><DeleteIcon colour='gray' /></div>
                </div>
            </div>
