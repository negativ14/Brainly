            ...
            <div className="w-screen h-screen bg-purple-100 flex">
                ...
                <div className="h-full w-2/5 bg-gradient-to-r from-purple-600 to-purple-400 flex justify-center items-center">
                    <div className="h-56 w-64 bg-white rounded-md shadow-md flex flex-col p-4 justify-start items-center">
                        ...
                        <div className="m-2">{responseMessage && (<p className={`${responseMessage.includes("successful!") || responseMessage.includes("successfully") ? "text-green-500" : "text-red-500 "} text-xs`}> {responseMessage} </p>)}</div>
                        <div className="flex gap-2 mt-2">
                            <div onClick={signinHandler}><Button variant="primary" text="SignIn" size="sm"></Button></div>
